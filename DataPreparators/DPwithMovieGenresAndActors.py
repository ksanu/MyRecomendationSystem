...
class DPwithMovieGenresAndActors:
    ...
    def getXy(self):
        ...
        DFMovieActors = pd.read_csv(datasetFilesPath + DFMovieActorsFileName, header=0, delimiter="\t",
                                    encoding='iso-8859-1', usecols=['movieID', 'actorID', 'ranking'], nrows=10000)
        ...
        DFUserRatedMoviesWithMovieGenresActors = pd.merge(DFUserRatedMoviesWithMovieGenres, DFMovieActorsPivoted,
                                                          on='movieID')
        ...
        DFUserRatedMoviesWithMovieGenresActors["rating"] = DFUserRatedMoviesWithMovieGenresActors["rating"] > \
                                                           DFUserRatedMoviesWithMovieGenresActors["rating"].mean()
